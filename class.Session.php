...
class Session
{
	...
	*/
	function destroy($session_id)
	{
		...
		$sql="DELETE FROM `Session Dimension` WHERE `Session ID` = '".$mysqli->real_escape_string($session_id)."'";
	...
	*/
	...
	{
		global $mysqli;
		$sql ="DELETE FROM `Session Dimension` WHERE `Session Expire` < '".$mysqli->real_escape_string(time() - $maxlifetime)."'";
